      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {paymentSuccess && (
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xs font-bold uppercase tracking-widest">Payment Successful! {paymentSuccess} credits added to your wallet.</span>
            </div>
        ...
        {verifyingPayment && (
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-widest">Verifying your payment...</span>
          </motion.div>
        )}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white p-8 border border-neutral-200 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xs font-semibold uppercase tracking-widest text-neutral-400">Wallet Balance</h3>
              <CreditCard className="w-4 h-4 text-neutral-900" />
            </div>
            <div className="flex items-end justify-between">
              <span className="text-3xl font-serif text-neutral-900">{profile?.credits || 0} Credits</span>
              <Link to="/buy-credits" className="text-xs font-bold uppercase tracking-widest border-b border-neutral-900 text-neutral-900 pb-1 hover:text-neutral-500 hover:border-neutral-500 transition-all">
                Buy More
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white p-8 border border-neutral-200 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xs font-semibold uppercase tracking-widest text-neutral-400">Membership Status</h3>
              <Star className={cn("w-4 h-4", profile?.role === 'member' ? "text-amber-500 fill-current" : "text-neutral-900")} />
            </div>
            <div className="flex items-end justify-between">
              <span className="text-3xl font-serif text-neutral-900 uppercase tracking-widest">
          ...
          <div className="bg-white p-8 border border-neutral-200 shadow-sm">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-xs font-semibold uppercase tracking-widest text-neutral-400">Upcoming Events</h3>
              <Calendar className="w-4 h-4 text-neutral-900" />
            </div>
            <div className="flex items-end justify-between">
              <span className="text-3xl font-serif text-neutral-900">{upcoming.length} Reservations</span>
              <Link to="/events" className="text-xs font-bold uppercase tracking-widest border-b border-neutral-900 text-neutral-900 pb-1 hover:text-neutral-500 hover:border-neutral-500 transition-all">
                Book New
              </Link>
            </div>
          </div>
        ...
        <div className="space-y-12">
          {/* Upcoming */}
          <section>
            <h2 className="text-xl font-serif mb-6 uppercase tracking-widest text-neutral-900">Upcoming Reservations</h2>
            {upcoming.length === 0 ? (
              <div className="bg-white border border-neutral-200 p-12 text-center">
                <p className="text-neutral-400 font-light italic mb-6">No upcoming reservations found.</p>
              ...
              <div className="grid grid-cols-1 gap-4">
                {upcoming.map(booking => {
                  ...
                  return (
                    <div key={booking.id} className="bg-white border border-neutral-200 p-6 flex flex-col md:flex-row md:items-center justify-between gap-6">
                      <div className="flex items-center gap-6">
                        ...
                        <div>
                          <h4 className="text-lg font-serif text-neutral-900 uppercase tracking-wider">{booking.event?.title}</h4>
                          <div className="flex items-center gap-4 text-xs text-neutral-400 uppercase tracking-widest mt-1">
                            <span className="flex items-center"><Calendar className="w-3 h-3 mr-1" /> {format(parseISO(booking.event!.dateTime), "MMM dd, yyyy")}</span>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right mr-4">
                          ...
                          <p className="text-lg font-serif text-neutral-900">{booking.totalCredits}</p>
                        </div>
                        <div className="flex flex-col gap-2">
                          {canCancel ? (
                            <Link 
                              to={`/booking/${booking.eventId}`}
                              className="px-6 py-2 text-[10px] text-center font-bold uppercase tracking-widest bg-neutral-900 text-white hover:bg-neutral-800 transition-all min-w-[140px]"
                            >
                              Edit
                            </Link>
                          ) : (
                            <Link 
                              ...
                              className="px-6 py-2 text-[10px] text-center font-bold uppercase tracking-widest border border-neutral-200 text-neutral-900 hover:bg-neutral-50 transition-all min-w-[140px]"
                            >
                              View Details
                            </Link>
                          )}
                          <button 
                            ...
                            className={cn(
                              "px-6 py-2 text-[10px] font-bold uppercase tracking-widest border transition-all disabled:opacity-50 min-w-[140px]",
          ...
          {/* Past */}
          <section>
            <h2 className="text-xl font-serif mb-6 uppercase tracking-widest text-neutral-400">Past Experiences</h2>
            <div className="grid grid-cols-1 gap-4 opacity-60">
              {past.map(booking => (
                <div key={booking.id} className="bg-white border border-neutral-200 p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 grayscale">
                  <div className="flex items-center gap-6">
                    ...
                    <div>
                      <h4 className="text-base font-serif text-neutral-900 uppercase tracking-wider">{booking.event?.title}</h4>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-base font-serif text-neutral-900">{booking.totalCredits}</p>
                  </div>
                </div>
              ))}
            </div>

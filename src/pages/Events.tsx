...
const Events = () => {
  ...
  return (
    <div className="bg-white min-h-screen py-24 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-serif text-neutral-900 mb-4 uppercase tracking-widest">Upcoming Experiences</h1>
            ...
            <div className="flex items-center space-x-3">
              {["Thali", "Brunch", "Curated"].map((type) => (
                <button
                  ...
                  className={cn(
                    "px-6 py-2 text-[10px] font-bold uppercase tracking-widest border transition-all flex items-center space-x-2",
            ...
            return (
              ...
              >
                ...
                <div className="p-8 flex-grow flex flex-col">
                  ...
                  {isSpecial && (
                    <div className="mb-4 p-2 bg-indigo-50 border border-indigo-100 rounded">
                      <p className="text-[10px] font-bold text-indigo-700 uppercase tracking-widest">
                        Member Pricing: {event.creditsPerPerson - 1} Credits
                      </p>
                    </div>
                  )}
